...
from .behaviours_clienttest import (
    AwaitClientImage,
    ClientTestWorkflowInputs,
...
from .state import ClientTestMeta, Package, PackageMeta, ReleaseMeta, Workflow
from .tree_factory_generic import GenericPackageFactory, PackageWithValidation


class ClientTestFactory(GenericPackageFactory, PackageWithValidation):
    ...
    def create_package_release_goal_tree_branch(
        ...
        if "clientimage" not in packages:
            raise ValueError("clientimage package not found in packages")
        ...
        package_sequence = Sequence(
            ...
            children=[
                ...
                AwaitClientImage(
                    ...
                    release_meta,
                    packages["clientimage"].meta,
                    packages["clientimage"].build,
                    log_prefix=package_name,
                ),
                LocateClientImage(
                    "Locate Client Image",
    ...
    def create_need_to_release_behaviour(
        ...
        return NeedToReleaseClientTest(
    ...
    def create_detect_release_type_behaviour(
        ...
        return DetectReleaseTypeClientTest(
            name, package_meta, release_meta, log_prefix=log_prefix
        )
    ...
    def create_build_workflow_inputs(
        ...
        return ClientTestWorkflowInputs(
            name,
            cast(ClientTestMeta, package_meta),
            workflow,
